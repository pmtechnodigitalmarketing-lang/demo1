const baseServices = [
  { id: "psychic-reading", title: "Psychic Reading", desc: "Gain profound insights into your past, present, and future. Discover hidden truths and unlock your highest potential.", color: "from-[#C85A3F] to-[#18181b]", image: "/images/_Affordable Psychic Card Readings_.webp" },
  { id: "love-solutions", title: "Love Solutions", desc: "Resolve severe relationship crises, stop divorce, and rekindle the love and passion in your life.", color: "from-[#C85A3F] to-[#18181b]", image: "/images/Reconnect & Co-Regulate_ Science-Based Tools for NYC Families.webp" },
  { id: "palmistry", title: "Palmistry", desc: "Your hands hold the map of your life. Learn what your heart, head, and life lines reveal about your destiny.", color: "from-[#C85A3F] to-[#18181b]", image: "/images/palmistry.webp" },
  { id: "bring-ex-back", title: "Bring Ex Back", desc: "Remove external interferences and misunderstandings to permanently reunite with your lost love.", color: "from-[#C85A3F] to-[#18181b]", image: "/images/3-months-rule-breakup.webp" },
  { id: "black-magic-removal", title: "Black Magic Removal", desc: "Identify and destroy dark energies, generational curses, and evil eye that are blocking your success.", color: "from-[#C85A3F] to-[#18181b]", image: "/images/black_magic.webp" },
  { id: "business-astrology", title: "Business Astrology", desc: "Overcome financial losses, attract lucrative opportunities, and ensure long-term business prosperity.", color: "from-[#C85A3F] to-[#18181b]", image: "/images/career-astrology-reading.webp" },
  { id: "spiritual-healing", title: "Spiritual Healing", desc: "Cleanse your aura, align your chakras, and remove deep-rooted trauma through powerful energy healing.", color: "from-[#C85A3F] to-[#18181b]", image: "/images/serene-village-landscape.webp" },
  { id: "voodoo-removal", title: "Voodoo Removal", desc: "Specialized rituals to completely break extreme forms of dark magic and witchcraft targeting your family.", color: "from-[#C85A3F] to-black", image: "/images/voodoo.webp" },
  { id: "face-reading", title: "Face Reading", desc: "Discover hidden personality traits and foresee health or career trajectories through ancient physiognomy.", color: "from-[#C85A3F] to-[#18181b]", image: "/images/Why Many Trust Facial Reading Astrology Services For Daily Guidance.webp" },
  { id: "family-disputes", title: "Family Disputes", desc: "Bring peace and unity back to a broken home by resolving toxic misunderstandings and jealousies.", color: "from-[#C85A3F] to-[#18181b]", image: "/images/family.webp" },
  { id: "court-cases", title: "Court Cases", desc: "Gain spiritual favor and astrological alignment for success in prolonged legal matters and disputes.", color: "from-[#C85A3F] to-[#18181b]", image: "/images/toxic-marriage-signs.webp" },
  { id: "childless-couples", title: "Childless Couples", desc: "Vedic prayers and planetary remedies to bless couples struggling with conception and fertility issues.", color: "from-[#C85A3F] to-[#18181b]", image: "/images/marriage.webp" },
  { id: "health-problems", title: "Health Problems", desc: "Find spiritual remedies for chronic illnesses, depression, and unexplainable physical conditions.", color: "from-[#C85A3F] to-[#18181b]", image: "/images/negative_energy.webp" },
  { id: "jealousy-envy", title: "Jealousy & Envy", desc: "Shield yourself and your assets from the destructive intentions and 'Evil Eye' of jealous individuals.", color: "from-[#C85A3F] to-[#18181b]", image: "/images/demon_forces.webp" },
  { id: "career-guidance", title: "Career Guidance", desc: "Stuck in your job? Find the career path that perfectly aligns with your astrological birth chart.", color: "from-[#C85A3F] to-[#18181b]", image: "/images/career-astrology-reading.webp" },
  { id: "kundali-matching", title: "Kundali Matching", desc: "Ensure a blissful and lifelong marriage by deeply analyzing the astrological compatibility of partners.", color: "from-[#C85A3F] to-[#18181b]", image: "/images/relationship_astrology_hero.webp" },
  { id: "vaastu-shastra", title: "Vaastu Shastra", desc: "Correct the energetic flow of your home or office to invite peace, wealth, and harmonious living.", color: "from-[#C85A3F] to-[#18181b]", image: "/images/astrologer-in-west-bengal.webp" },
  { id: "gemstone-consultation", title: "Gemstone Consultation", desc: "Discover which precious stones will amplify your lucky planets and neutralize malefic influences.", color: "from-[#C85A3F] to-[#18181b]", image: "/images/gemstone-recommendation.webp" },
  { id: "depression-anxiety", title: "Depression & Anxiety", desc: "Holistic spiritual counseling and remedies to lift the heavy fog of mental distress and anxiety.", color: "from-[#C85A3F] to-[#18181b]", image: "/images/Arquivos sofrimento - Blog Consultório Sentimental.jpg" },
  { id: "property-disputes", title: "Property Disputes", desc: "Resolve inherited wealth conflicts and property issues smoothly through specific planetary appeasements.", color: "from-[#C85A3F] to-[#18181b]", image: "/images/6825836929131189.webp" },
  { id: "aura-cleansing", title: "Aura Cleansing", desc: "Remove stagnant negative energy and restore your natural glowing auric field for increased magnetism.", color: "from-[#C85A3F] to-[#18181b]", image: "/images/negative_energy.webp" },
  { id: "past-life-regression", title: "Past Life Regression", desc: "Uncover unresolved karmic debts from previous lifetimes that are currently blocking your success.", color: "from-[#C85A3F] to-[#18181b]", image: "/images/past-life-regression.webp" },
  { id: "dream-interpretation", title: "Dream Interpretation", desc: "Decode the cryptic messages your subconscious and spirit guides are sending you during sleep.", color: "from-[#C85A3F] to-[#18181b]", image: "/images/dream-interpretation.webp" },
...
const uniqueExpansions = {
  ...
  "aura-cleansing": "Over time, negative interactions leave psychic debris in your energy field. Pandit Rudradev uses ancient sound frequencies and sage rituals to purify your aura, making you instantly lighter and more attractive to positive opportunities.",
  "past-life-regression": "Many of your current fears, phobias, and recurring relationship patterns stem from unresolved trauma in past lives. Through deep meditative guidance, Pandit Rudradev helps you access and heal these ancient wounds, freeing your present timeline.",
  "dream-interpretation": "Dreams are the language of the cosmos. Pandit Rudradev acts as a translator for your soul, identifying recurring symbols and prophetic warnings to give you actionable advice for your waking life.",
