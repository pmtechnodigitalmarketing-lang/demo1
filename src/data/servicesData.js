const baseServices = [
  ...
  { id: "depression-anxiety", title: "Depression & Anxiety", desc: "Holistic spiritual counseling and remedies to lift the heavy fog of mental distress and anxiety.", color: "from-[#6366f1] to-[#18181b]", image: "/images/Arquivos sofrimento - Blog Consultório Sentimental.jpg" },
  ...
  { id: "aura-cleansing", title: "Aura Cleansing", desc: "Remove stagnant negative energy and restore your natural glowing auric field for increased magnetism.", color: "from-[#6366f1] to-[#18181b]", image: "/images/negative_energy.webp" },
  { id: "past-life-regression", title: "Past Life Regression", desc: "Uncover unresolved karmic debts from previous lifetimes that are currently blocking your success.", color: "from-[#6366f1] to-[#18181b]", image: "/images/past-life-regression.webp" },
  { id: "dream-interpretation", title: "Dream Interpretation", desc: "Decode the cryptic messages your subconscious and spirit guides are sending you during sleep.", color: "from-[#6366f1] to-[#18181b]", image: "/images/dream-interpretation.webp" },
  { id: "financial-blockages", title: "Financial Blockages", desc: "Break through invisible glass ceilings preventing you from accumulating the wealth you deserve.", color: "from-[#6366f1] to-[#18181b]", image: "/images/finance_symptom.jpg" },
  { id: "chakra-balancing", title: "Chakra Balancing", desc: "Realign your seven primary energy centers to achieve perfect physical and emotional harmony.", color: "from-[#6366f1] to-[#18181b]", image: "/images/Como Alinhar os Chakras_ Um Guia Completo para Equilibrar Sua Energia Interior.webp" },
  { id: "karmic-healing", title: "Karmic Healing", desc: "Sever unhealthy soul ties and heal ancestral trauma passed down through your bloodline.", color: "from-[#6366f1] to-[#18181b]", image: "/images/generational_symptom.jpg" },
  { id: "entity-attachment", title: "Entity Removal", desc: "Safely detach parasitic spiritual entities that are draining your life force and causing fatigue.", color: "from-[#6366f1] to-[#18181b]", image: "/images/dark_energy_symptom.jpg" }
];
