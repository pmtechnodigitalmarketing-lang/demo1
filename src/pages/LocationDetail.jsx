  ...
  return (
    <div className="w-full pt-20 pb-4 lg:pb-8 px-6 relative z-10 min-h-screen">
      <div className="container mx-auto max-w-7xl">
        ...
        {/* Hero Section */}
        <div ref={heroRef} className="relative w-full h-[400px] md:h-[500px] rounded-[3rem] overflow-hidden mb-10 md:mb-16 glass border border-[var(--color-space-purple)]/10 flex items-center justify-center group [perspective:1000px]">
          <div className="absolute inset-0 bg-gradient-to-br from-[var(--color-space-gray)]/40 to-[var(--color-space-cyan)]/20 mix-blend-overlay z-10"></div>
          ...
          <motion.div
            ...
            className="absolute top-10 left-10 w-32 h-32 bg-[var(--color-space-gray)] rounded-full blur-[60px] opacity-30 z-0"
          />
          <motion.div
            animate={{
              y: [0, 40, 0],
            ...
            className="absolute bottom-10 right-10 w-48 h-48 bg-[var(--color-space-cyan)] rounded-full blur-[80px] opacity-20 z-0"
          />
          ...
          <motion.div style={{ opacity: opacityText }} className="relative z-20 text-center px-6">
            ...
            >
              ...
              <h1 className="text-3xl md:text-5xl md:text-7xl font-bold text-white mb-6 tracking-tight drop-shadow-2xl">
                Astrology in <span className="text-[var(--color-space-cyan)] drop-shadow-[0_0_8px_rgba(69,243,255,0.3)] text-white drop-shadow-md">{formattedCity}</span>
              </h1>
            </motion.div>
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          className="max-w-4xl mx-auto text-center mb-12 lg:mb-24 glass p-6 md:p-10 rounded-3xl border border-[var(--color-space-purple)]/10 shadow-2xl relative"
        >
          <div className="absolute -top-10 -left-10 w-32 h-32 bg-[var(--color-space-gray)] opacity-10 rounded-full blur-[40px]"></div>
        ...
        <div className="mb-10 md:mb-16">
          ...
          >
            All Services Provided in <br /><span className="text-[var(--color-space-cyan)] drop-shadow-[0_0_8px_rgba(69,243,255,0.3)] text-white drop-shadow-md">{formattedCity}</span>
          </motion.h2>
            ...
            {allServices.map((service, index) => (
              ...
              >
                <Link
                  ...
                  className="group flex flex-col justify-end relative overflow-hidden min-h-[260px] md:min-h-[280px] p-6 md:p-8 rounded-3xl border border-[var(--color-space-purple)]/10 hover:border-[var(--color-space-light)]"
                >
                  {/* Background Image */}
                  <div
                  ...
                  <div className="relative z-10 flex flex-col h-full justify-end">
                    <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-[var(--color-space-cyan)] transition-colors drop-shadow-md">{service.title}</h3>
                    <div className="pt-4 border-t border-[var(--color-space-purple)]/20 w-full group-hover:border-[var(--color-space-light)]">
                      <span className="inline-flex items-center gap-2 text-sm text-[var(--color-space-cyan)] font-semibold group-hover:text-white transition-colors">
